async function loadBooks() {
    const URL = "http://localhost:5050/api/books";
        ...
        <div class="col-4">
            <div id="book-${book.isbn}" class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editBookModal" onClick="showBook('${book.isbn}')">Show</button>
                </div>
            </div>
        </div>
        `
